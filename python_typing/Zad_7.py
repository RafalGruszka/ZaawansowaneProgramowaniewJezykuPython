...
class Brewery:
    ...
    def __str__(self):
        return (f"Brewery: {self.name}, Type: {self.brewery_type}, Address: "
                f"{self.address1}, {self.address2}, {self.address3}, "
                f"{self.city}, {self.state_province}, {self.postal_code}, "
                f"{self.country}, Longitude: {self.longitude}, Latitude: "
                f"{self.latitude}, Phone: {self.phone}, Website: "
                f"{self.website_url}, State: {self.state}, "
